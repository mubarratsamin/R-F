...
// Delete technician if delete request is made
if (isset($_GET['delete_id'])) {
    ...
    if ($stmt->execute()) {
        // Successfully deleted the technician
        $deleteMessage = true;
    } else {
        echo "Error deleting technician: " . $stmt->error;
    }
...
<head>
    ...
    <style>
        ...
        .delete-button {
            ...
            padding: 5px 10px;
            cursor: pointer;
            position: absolute; /* Positioning the delete button */
            right: 10px;
            top: 10px;
        }
...
<body>
    ...
    <a href="admin_index.php" class="home-icon"><i class="fas fa-home"></i></a> <!-- Home Icon -->
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="technician-card">
                    ...
                    <form method="GET" action="manage_technician.php" style="display:inline;">
                        <input type="hidden" name="delete_id" value="<?php echo $row['id']; ?>">
                        <button type="submit" class="delete-button" onclick="return confirm('Are you sure you want to delete this technician?');">Delete</button>
                    </form>
